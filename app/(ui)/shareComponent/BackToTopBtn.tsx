  ...
  return (
    showButton && (
      <div className="fixed w-full flex justify-end">
        <motion.button initial={{ opacity: 0 }} animate={{ opacity: 1 }} onClick={scrollToTop} className="fixed bottom-20 left-[50%] -translate-x-[50%] w-10 h-10 flex justify-center items-center p-3 rounded-full shadow-md hover:bg-slate-50 transition-all">
          ↑
        </motion.button>
      </div>
    )
