...
export const AboutMe =() => {
    return (
      <>
        <div className="pt-20 grid gap-20 grid-cols-2">
          ...
          <motion.div className="bg-red-200 h-64" initial={{ translateY: 10, opacity: 0, scale: 0.99 }} animate={{ translateY: 0, opacity: 1, scale: 1 }} transition={{ duration: 0.3, ease: [0, 0.1, 0.7, 1.01] }}></motion.div>
        </div>
      </>
    );
}