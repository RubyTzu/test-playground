    ...
    <div className="mt-0 xl:mt-2">
      <div className="flex flex-col justify-between items-end md:items-center md:flex-row">
        ...
        <div className="flex  gap-5 pt-7 md:gap-6 md:pt-0">
          <Link href={projectData.demoUrl} target="_blank" className="border-b-primary-300 border-b-2 cursor-pointer h-fit">
            Demo
          </Link>
          <motion.div initial={{ translateX: -1, opacity: 0, scale: 0.99 }} animate={{ translateX: 0, opacity: 1, scale: 1 }} transition={{ duration: 0.3, ease: [0, 0.1, 0.7, 1.01] }} className="border-b-primary-300 border-b-2 w-fit h-fit">
