...
export const ProjectIntro = ({ projectData }: { projectData: ProjectDetails }) => {
  return (
    <div className="mt-0 2xl:mt-36">
      ...
      <Image src={projectData.longImg} width={1920} height={1080} alt="test image" className="mt-8 w-full h-72 object-cover border md:h-56 md:mt-4 xl:mt-8 2xl:mt-16 2xl:h-96"></Image>
